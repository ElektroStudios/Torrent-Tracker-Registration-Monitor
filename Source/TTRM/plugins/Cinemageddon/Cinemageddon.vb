...
<DebuggerStepThrough>
Class CinemageddonPlugin : Inherits DynamicPlugin

    ' 📝 Notes
    ' ━━━━━━━━
    '
    ' Login URL is Cloudflare-protected, so use a non-headless Chrome browser if need to interact with it.

    ReadOnly headless As Boolean = True
    ReadOnly additionalArgs As String() = Array.Empty(Of String)

    ReadOnly registrationTriggers As String() = {"You will need to obtain an invite"}
