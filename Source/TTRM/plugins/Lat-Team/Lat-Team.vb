...
<DebuggerStepThrough>
Class LatTeamPlugin : Inherits DynamicPlugin

    ReadOnly headless As Boolean = True
    ReadOnly additionalArgs As String() = Array.Empty(Of String)

    ReadOnly registrationTriggers As String() = {"Registration Is Disabled", "registro abierto está deshabilitado"}
    ReadOnly registrationTriggersIndicatesOpen As Boolean = False

    ReadOnly applicationTriggers As String() = {"Applications Are Closed", "Las aplicaciones están cerradas"}
