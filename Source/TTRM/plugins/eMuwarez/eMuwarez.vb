...
<DebuggerStepThrough>
Class EmuwarezPlugin : Inherits DynamicPlugin

    ReadOnly headless As Boolean = True
    ReadOnly additionalArgs As String() = Array.Empty(Of String)

    ReadOnly registrationTriggers As String() = {"Open registration is disabled", "Registros están CERRADOS"}
    ReadOnly registrationTriggersIndicatesOpen As Boolean = False

    ReadOnly applicationTriggers As String() = {"Applications are closed", "aplicaciones están cerradas"}
