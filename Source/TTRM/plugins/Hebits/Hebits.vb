...
<DebuggerStepThrough>
Class HebitsPlugin : Inherits DynamicPlugin

    ReadOnly headless As Boolean = True
    ReadOnly additionalArgs As String() = Array.Empty(Of String)

    ReadOnly registrationTriggers As String() = {"מצטערים, ההרשמה מותנית בהזמנה בלבד"}
    ReadOnly registrationTriggersIndicatesOpen As Boolean = False

    ReadOnly applicationTriggers As String() = {"חובה למלא את כל השדות"}
