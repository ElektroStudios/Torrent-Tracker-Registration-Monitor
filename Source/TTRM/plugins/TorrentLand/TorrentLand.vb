...
Class TorrentLandPlugin : Inherits DynamicPlugin
    ...
    ReadOnly registrationTriggers As String() = {"Registro libre cerrado"}
    ReadOnly registrationTriggersIndicatesOpen As Boolean = False

    ReadOnly applicationTriggers As String() = {"Necesitas que alguien te envíe una invitación para entrar"}
