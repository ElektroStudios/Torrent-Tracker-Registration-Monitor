...
<div align="center">
  ...
  <h1>Torrent Tracker Registration Monitor (TTRM)</h1>

### A desktop application to automate registration availability checks across multiple private torrent trackers and forums.
...
<p align="center">
    <a href="https://github.com/ElektroStudios/Torrent-Tracker-Registration-Monitor/network/members"><img src="https://img.shields.io/github/forks/ElektroStudios/Torrent-Tracker-Registration-Monitor.svg?style=social&logo=data%3Aimage%2Fsvg%2Bxml%3Bbase64%2CPHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPjwvc3ZnPg%3D%3D&label=%F0%9F%8D%B4%20Forks" alt="Forks"></a>&nbsp;
    <a href="https://github.com/ElektroStudios/Torrent-Tracker-Registration-Monitor/graphs/contributors"><img src="https://img.shields.io/github/contributors/ElektroStudios/Torrent-Tracker-Registration-Monitor.svg?style=social&logo=data%3Aimage%2Fsvg%2Bxml%3Bbase64%2CPHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPjwvc3ZnPg%3D%3D&label=%F0%9F%91%A5%20Contributors" alt="Contributors"></a>&nbsp;
    ...
    <a href="https://github.com/ElektroStudios/Torrent-Tracker-Registration-Monitor/watchers"><img src="https://img.shields.io/github/watchers/ElektroStudios/Torrent-Tracker-Registration-Monitor.svg?style=social&logo=data%3Aimage%2Fsvg%2Bxml%3Bbase64%2CPHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPjwvc3ZnPg%3D%3D&label=%F0%9F%91%80%20Watchers" alt="Watchers"></a>
    ...
    <a href="https://github.com/ElektroStudios/Torrent-Tracker-Registration-Monitor/stargazers"><img src="https://img.shields.io/github/stars/ElektroStudios/Torrent-Tracker-Registration-Monitor.svg?style=social&logo=data%3Aimage%2Fsvg%2Bxml%3Bbase64%2CPHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPjwvc3ZnPg%3D%3D&label=%E2%AD%90%20Stars" alt="Stars"></a>
  <br>
  <br>
    <a href="https://ci.appveyor.com/project/ElektroStudios/Torrent-Tracker-Registration-Monitor"><img src="https://ci.appveyor.com/api/projects/status/github/ElektroStudios/Torrent-Tracker-Registration-Monitor?svg=true" alt="AppVeyor CI"></a>
    <a href="https://sonarcloud.io/summary/new_code?id=ElektroStudios_Torrent-Tracker-Registration-Monitor"><img src="https://sonarcloud.io/api/project_badges/measure?project=ElektroStudios_Torrent-Tracker-Registration-Monitor&metric=alert_status" alt="SonarCloud Quality Gate"></a>
    <a href="https://github.com/ElektroStudios/Torrent-Tracker-Registration-Monitor/releases/latest"><img src="https://img.shields.io/github/v/release/ElektroStudios/Torrent-Tracker-Registration-Monitor" alt="Latest Release"></a>
    ...
    <a href="LICENSE"><img src="https://img.shields.io/github/license/ElektroStudios/Torrent-Tracker-Registration-Monitor" alt="License"></a>
  <br>
    <a href="https://api.github.com/repos/ElektroStudios/Torrent-Tracker-Registration-Monitor/zipball"><img src="https://img.shields.io/github/repo-size/ElektroStudios/Torrent-Tracker-Registration-Monitor" alt="Repo size"></a>
    <a href="https://somsubhra.github.io/github-release-stats/?username=ElektroStudios&repository=Torrent-Tracker-Registration-Monitor"><img src="https://img.shields.io/github/downloads/ElektroStudios/Torrent-Tracker-Registration-Monitor/total.svg?label=total%20downloads" alt="Total Downloads"></a>
    <a href="https://github.com/ElektroStudios/Torrent-Tracker-Registration-Monitor/commits"><img src="https://img.shields.io/github/last-commit/ElektroStudios/Torrent-Tracker-Registration-Monitor" alt="Last commit"></a>
    <a href="https://github.com/ElektroStudios/Torrent-Tracker-Registration-Monitor/pulls"><img src="https://img.shields.io/github/issues-pr/ElektroStudios/Torrent-Tracker-Registration-Monitor" alt="Pull Requests"></a>
    <a href="https://github.com/ElektroStudios/Torrent-Tracker-Registration-Monitor/issues?q=is%3Aissue+is%3Aopen"><img src="https://img.shields.io/github/issues/ElektroStudios/Torrent-Tracker-Registration-Monitor?color=blue" alt="Open Issues"></a><a href="https://github.com/ElektroStudios/Torrent-Tracker-Registration-Monitor/issues?q=is%3Aissue+is%3Aclosed"><img src="https://img.shields.io/github/issues-closed/ElektroStudios/Torrent-Tracker-Registration-Monitor?label=&color=28a745" alt="Closed Issues"></a>
    <a href="https://github.com/ElektroStudios/Torrent-Tracker-Registration-Monitor/pulse"><img src="https://img.shields.io/badge/maintained-yes-green.svg" alt="Maintenance"></a>
  <br>
  <br>
...
**Torrent Tracker Registration Monitor (TTRM)** is a desktop utility designed to automatically monitor and report the account registration availability across multiple private torrent trackers. Instead of manually navigating to dozens of sites to check if the registration gates are open, this tool handles the scraping and monitoring for you through a modular, scalable plugin system powered by Selenium WebDriver.

## 💡 Motivation

Gaining access to top-tier private trackers is often a waiting game of attrition. Open registration windows are incredibly brief, unannounced, and easily missed if you are not constantly refreshing the sign-up pages.

This project was built to automate the tedious process of manual checking. By building a robust plugin architecture, the community can easily write and integrate small scripts (plugins) to check the specific DOM elements of any tracker. The app centralizes all these checks into a clean UI, running quietly and alerting you the moment a registration gate opens.

##### ⚡ The Real Question
###### Why waste your time manually refreshing dozens of tracker sign-up pages every day when a lightweight desktop tool can quietly monitor them all for you?.
...
## 🚀 Getting Started (standard users)

1. Navigate to the **[Releases page](https://github.com/ElektroStudios/Torrent-Tracker-Registration-Monitor/releases/latest)**.
...
💡 Remember to read the included `README.txt` file located in the `docs` folder for more details and also tips for using the application. 
...
Install the application following the steps avobe for standard users, then read the included `README (for programmers).md` file located in the `docs` folder for more details. 
